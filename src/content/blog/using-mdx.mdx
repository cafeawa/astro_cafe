...
Here is how you use Astro components inside of MDX.
When you open this page in the browser, you should see the styled tag badge below.

import TagBadge from '../../components/TagBadge.astro';

<div style="display: flex; gap: 0.5rem; margin-top: 1rem;">
  <TagBadge tag="astro" size="md" />
  <TagBadge tag="mdx" size="md" />
  <TagBadge tag="tailwind" size="md" />
</div>
